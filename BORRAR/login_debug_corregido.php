<?php
// Versión corregida del debug que usa la misma configuración que funcionó
error_reporting(E_ALL);
ini_set('display_errors', 1);

session_start();

echo "<h2>Debug del Login - VERSIÓN CORREGIDA</h2>";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($password)) {
        ...
        try {
            ...
            // USAR LA MISMA CONFIGURACIÓN QUE FUNCIONÓ
            ...
            $debug_info[] = "Base de datos actual: " . $current_db;
            ...
            error_log("Error en login_debug_corregido.php: " . $e->getMessage());
        }
    }
}
?>
...
<head>
    ...
    <title>Debug Login Corregido - MiniBasket Pro</title>
    <style>
...
<body>
    <h1>Debug del Sistema de Login - VERSIÓN CORREGIDA</h1>
    ...
    <div class="form-container">
        ...
        <form action="login_debug_corregido.php" method="post">
